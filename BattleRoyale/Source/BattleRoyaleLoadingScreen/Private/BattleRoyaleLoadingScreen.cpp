...
struct FBattleRoyaleLoadingScreenBrush : public FSlateDynamicImageBrush, public FGCObject
{
	FBattleRoyaleLoadingScreenBrush( const FName InTextureName, const FVector2D& InImageSize )
...
class FBattleRoyaleLoadingScreenModule : public IBattleRoyaleLoadingScreenModule
{
public:
...
IMPLEMENT_GAME_MODULE(FBattleRoyaleLoadingScreenModule, BattleRoyaleLoadingScreen);
