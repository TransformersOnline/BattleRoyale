...
#include "BattleRoyaleDelegates.h"
...
class FBattleRoyaleModule : public FDefaultGameModuleImpl
{
	virtual void StartupModule() override
	{
		InitializeBattleRoyaleDelegates();
...
IMPLEMENT_PRIMARY_GAME_MODULE(FBattleRoyaleModule, BattleRoyale, "BattleRoyale");
