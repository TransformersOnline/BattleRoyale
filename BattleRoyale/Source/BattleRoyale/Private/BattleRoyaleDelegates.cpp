	...
	if (URL == TEXT("/index.html?scoreboard"))
	{
		...
		if (GameEngine)
		{
			...
			{			
				...
				{
					// get the shoter game
					ABattleRoyaleState* const GameState = Player->PlayerController->GetWorld()->GetGameState<ABattleRoyaleState>();
...
void InitializeBattleRoyaleDelegates()
{
