...
)
{
	...
	UBattleRoyaleInstance* BattleRoyaleInstance = Cast<UBattleRoyaleInstance>(GetGameInstance());

	if (BattleRoyaleInstance)
	{
		...
		BattleRoyaleInstance->SetPendingInvite(PendingInvite);
		BattleRoyaleInstance->GotoState(BattleRoyaleInstanceState::PendingInvite);
	}
}
...
{	
	if (UBattleRoyaleInstance* const BattleRoyaleInstance = Cast<UBattleRoyaleInstance>(GetGameInstance()))
	{
		BattleRoyaleInstance->OnPlayTogetherEventReceived(UserIndex, UserIdList);
	}
}