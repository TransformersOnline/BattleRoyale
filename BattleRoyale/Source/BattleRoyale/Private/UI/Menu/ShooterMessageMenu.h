...
class UBattleRoyaleInstance;

class FShooterMessageMenu : public TSharedFromThis<FShooterMessageMenu>
{
public:
	/** build menu */
	void Construct(TWeakObjectPtr<UBattleRoyaleInstance> InGameInstance, TWeakObjectPtr<ULocalPlayer> InPlayerOwner, const FText& Message, const FText& OKButtonText, const FText& CancelButtonText,  const FName& InPendingNextState);
...
private:
	...
	TWeakObjectPtr<UBattleRoyaleInstance> GameInstance;
