...
public:
	/** build menu */
	void Construct( TWeakObjectPtr< class UBattleRoyaleInstance > InGameInstance );
	...
	TWeakObjectPtr< class UBattleRoyaleInstance > GetGameInstance() { return GameInstance; }

private:
	/** Owning game instance */
	TWeakObjectPtr< class UBattleRoyaleInstance > GameInstance;
