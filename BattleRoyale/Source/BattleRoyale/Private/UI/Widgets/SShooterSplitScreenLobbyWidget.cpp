...
#define LOCTEXT_NAMESPACE "BattleRoyale.SplitScreenLobby"
...
#if PLATFORM_SWITCH
	PressToPlayText = LOCTEXT("PressToPlay", "<img src=\"BattleRoyale.Switch.Right\"/> Select User");
	PressToFindText = LOCTEXT("PressToFind", "Press <img src=\"BattleRoyale.Switch.Right\"/> to Find Match");
	PressToStartMatchText = LOCTEXT("PressToStart", "<img src=\"BattleRoyale.Switch.Right\"/> Start Match / <img src=\"BattleRoyale.Switch.Up\"/> Connect Controllers");
	PlayAsGuestText = LOCTEXT("PlayAsGuest", "<img src=\"BattleRoyale.Switch.Left\"/> Play As Guest");
#endif	
...
//								.ColorAndOpacity(MenuTitleTextColor)
							...
							[							
								SNew(SRichTextBlock)
								.TextStyle(FShooterStyle::Get(), "BattleRoyale.SplitScreenLobby.StartMatchTextStyle")							
...
{
	UBattleRoyaleViewportClient* ShooterViewport = Cast<UBattleRoyaleViewportClient>(GetGameInstance()->GetGameViewportClient());
...
UBattleRoyaleInstance * SShooterSplitScreenLobby::GetGameInstance() const
{
	...
	check( PlayerOwner->GetGameInstance() == nullptr || CastChecked< UBattleRoyaleInstance >( PlayerOwner->GetGameInstance() ) != nullptr );

	return Cast< UBattleRoyaleInstance >( PlayerOwner->GetGameInstance() );
}
