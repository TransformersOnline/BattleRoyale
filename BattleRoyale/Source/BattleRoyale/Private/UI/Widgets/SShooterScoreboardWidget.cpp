...
void SShooterScoreboardWidget::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			SNew(SImage)
			.Image(FShooterStyle::Get().GetBrush("BattleRoyale.Speaker"))
		...
		[
			...
			[
				...
				.TextStyle(FShooterStyle::Get(), "BattleRoyale.DefaultScoreboard.Row.HeaderTextStyle")
			]
		]
	];
...
FText SShooterScoreboardWidget::GetMatchRestartText() const
{
	...
	{
		ABattleRoyaleState* const GameState = PCOwner->GetWorld()->GetGameState<ABattleRoyaleState>();
		if (GameState)
		{
			...
			[
				...
				[
					...
					[
						...
						.TextStyle(FShooterStyle::Get(), "BattleRoyale.DefaultScoreboard.Row.StatTextStyle")
...
FSlateColor SShooterScoreboardWidget::GetPlayerColor(const FTeamPlayer TeamPlayer) const
{
	...
	const FTextBlockStyle& TextStyle = FShooterStyle::Get().GetWidgetStyle<FTextBlockStyle>("BattleRoyale.DefaultScoreboard.Row.StatTextStyle");
