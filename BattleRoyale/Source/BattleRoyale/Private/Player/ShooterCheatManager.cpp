...
void UShooterCheatManager::ToggleMatchTimer()
{
	...
	ABattleRoyaleState* const MyGameState = MyPC->GetWorld()->GetGameState<ABattleRoyaleState>();
...
void UShooterCheatManager::ForceMatchStart()
{
	...
	ABattleRoyaleMode* const MyGame = MyPC->GetWorld()->GetAuthGameMode<ABattleRoyaleMode>();
