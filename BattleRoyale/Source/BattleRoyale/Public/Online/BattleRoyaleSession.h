...
#include "BattleRoyaleSession.generated.h"

struct FBattleRoyaleSessionParams
{
...
protected:
	...
	FBattleRoyaleSessionParams CurrentSessionParams;
	 ...
	 */
	DECLARE_EVENT_TwoParams(ABattleRoyaleSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(ABattleRoyaleSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(ABattleRoyaleSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(ABattleRoyaleSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
